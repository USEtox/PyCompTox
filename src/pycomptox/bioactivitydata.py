...
class BioactivityData:
    ...
    def get_summary_by_dtxsid_and_tissue(self, dtxsid: str, tissue: str) -> dict:
        """
    ...
    def get_summary_by_dtxsid(self, dtxsid: str) -> dict:
        """
    ...
    def get_summary_by_aeid(self, aeid: str) -> dict:
        """
        Get summary by aeid
    ...
    def get_data_by_spid(self, spid: str) -> dict:
        """
    ...
    def get_data_by_m4id(self, m4id: str) -> dict:
        """
    ...
    def get_data_by_dtxsid_and_projection(self, dtxsid: str, projection: str="") -> dict:
        """
    ...
    def get_data_by_aeid(self, aeid: int) -> dict:
        """
    ...
    def get_aed_data_by_dtxsid(self, dtxsid: str) -> dict:
        """
    ...
    def find_bioactivity_data_by_spid_batch(self, spids: list) -> dict:
        """
        ...
        return self._make_request("POST", endpoint, json_data=spids)

    def find_bioactivity_data_by_m4id_batch(self, m4ids: list) -> dict:
        """
        ...
        return self._make_request("POST", endpoint, json_data=m4ids)

    def find_bioactivity_data_by_dtxsid_batch(self, dtxsids: list) -> dict:
        """
    ...
    def find_bioactivity_data_by_aeid_batch(self, aeids: list) -> dict:
        """
        ...
        return self._make_request("POST", endpoint, json_data=aeids)

    def find_aed_data_by_dtxsid_batch(self, dtxsids: list) -> dict:
        """
