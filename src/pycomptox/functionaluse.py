...
class FunctionalUse:
    ...
    def functiona_use_by_dtxsid(self, dtxsid: str) -> List[Dict[str, Any]]:
        """
        Get functional use data for a chemical.
    ...
    def functional_use_probability_by_dtxsid(self, dtxsid: str) -> List[Dict[str, Any]]:
        """
    ...
    def functiona_use_categories(self) -> List[Dict[str, Any]]:
        """
    ...
    def functional_use_by_dtxsid_batch(self, dtxsids: List[str]) -> List[Dict[str, Any]]:
        """
