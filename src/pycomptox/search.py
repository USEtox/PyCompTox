...
class Chemical:
    ...
    def search_by_starting_value(self, value: str) -> List[Dict[str, Any]]:
        """
    ...
    def search_by_substring_value(self, value: str) -> List[Dict[str, Any]]:
        """
    ...
    def search_by_msready_formula(self, formula: str) -> List[str]:
        """
    ...
    def search_by_exact_formula(self, formula: str) -> List[str]:
        """
    ...
    def search_ms_ready_by_mass_range(self, min_mass: float, max_mass: float) -> List[str]:
        """
    ...
    def search_ms_ready_by_formula(self, formula: str) -> List[str]:
        """
    ...
    def search_ms_ready_by_dtxcid(self, dtxcid: str) -> List[str]:
        """
    ...
    def search_chemical_count_by_ms_ready_formula(self, formula: str) -> int:
        """
    ...
    def search_chemical_count_by_exact_formula(self, formula: str) -> int:
        """
    ...
    def search_by_exact_batch_values(self, values: List[str]) -> List[Dict[str, Any]]:
        """
        ...
        result = self._make_request(endpoint, method='POST', json=request_body)
    ...
    def search_ms_ready_by_mass_range_batch(
        ...
        return self._make_request(endpoint, method='POST', json=request_body)

    def search_ms_ready_by_dtxcid_batch(self, dtxcids: List[str]) -> Any:
        """
        ...
        return self._make_request(endpoint, method='POST', json=dtxcids)
